...
public:
  ...
  double BpCt3D_;
  double BpCt2DBS_;
  double BpCt3DPVCosTheta_;
  double BpCt2DPVCosTheta_;
  double BpCt3DPVClosestZ_;
  double BpCt2DPVClosestZ_;
  ...
  double BpPVx_refit_closestZ_;
  double BpPVy_refit_closestZ_;
  double BpPVz_refit_closestZ_;

  double BpPVx_refit_cosTheta_;
  double BpPVy_refit_cosTheta_;
  double BpPVz_refit_cosTheta_;

  double BpPVCL_;
  double BpPVCL_CosTheta_;
  double BpPVCL_ClosestZ_;
  double BpJpsiVtxCL_;
  double BpVtxCL_;
  double BpdRKaonJpsi_;
  double BpSVx_;
  double BpSVy_;
  double BpSVz_;
  double BpCtErr2DClosestZ_;
  double BpCtErr2D_;
  ...
  int    BpmatchDoubleMu41_v12_;
  int    BpmatchDoubleMu42_v12_;
 ...
 int JpsiMuonMatch41_ ;
 int JpsiMuonMatch42_ ;
 double deltaRkaon1Jpsi_;
 double deltaRkaon2Jpsi_;
 double deltaRBCandPion_;
 ...
 int JpsiMu1TrackerMuonArbitrated_ ;
 int JpsiMu2TrackerMuonArbitrated_ ;
 ...
 double JpsiMu1EtaMC_;
 double JpsiMu2EtaMC_;

 double JpsiMu2PtMC_;
 double JpsiMu1PtMC_;

 double JpsiMu2PhiMC_;
 double JpsiMu1PhiMC_;
 double JpsiCosAlphaMC_;
 ...
 int JpsiMu2momId_ ;
  ...
  double PVx_refit_cosTheta_ ;
  double PVy_refit_cosTheta_ ;
  double PVz_refit_cosTheta_ ;	

  double PVx_refit_closestZ_ ;
  double PVy_refit_closestZ_ ;
  double PVz_refit_closestZ_ ;	
  ...
  double BpCtErr2DBS_;
  double BsCtErr2DBS_JpsiVtx_;
  double BsCtErr2D_JpsiVtx_;
  double BsCtErr2DClosestZ_JpsiVtx_;
  double BsCtErr2DCostheta_JpsiVtx_;
  ...
  int    Mu1SoftID_;
  int    Mu2SoftID_;
  int    triggerbit_HLTmu4TkDis_;
  int    triggerbit_HLTmu4TkTkDis_;
  int    triggerbit_HLTDimuon0JpsiMuon_;
//Dimuon0JpsiMuon  
int    triggerbit_HLTdoubleIsoMu3_;
  ...
  double	BpMuonPairDR_;
  double MuonPairDR_;
  double K1Pt_nofit_;
  double K1HighPurityTrack_;	
  double K2HighPurityTrack_;	
  double K1Pz_nofit_;
  double K1Eta_nofit_;
  double K1Phi_nofit_;
  int    K1Key_nofit_;
  ...
  double BpMu1TrkBSDxy_;
  double BpMu1TrkBSDz_;
  double BpMu2TrkBSDxy_;
  double BpMu2TrkBSDz_;


  int BpMu1PixelHits_ ;
  int BpMu1TrackerHits_;
  int BpMu1isGood_ ;
  int BpMu1InnerTrkHighQuality_ ;

  int BpMu2PixelHits_ ;
  int BpMu2TrackerHits_ ;
  int BpMu2isGood_ ;
  int BpMu2InnerTrkHighQuality_ ;
  ...
  double BsCtErr2DCosthetaOld_;
  double BsCt3DPVCosTheta_;
  double BsCt2DPVCosTheta_;
  double BsCt2DPVCosThetaOld_;
  double BsCt3DPVClosestZ_;
  double BsCt2DPVClosestZ_;
  double BsDist3d_;
  double BsDist3dErr_;
  double BsTime3d_;
  double BsTime3dErr_;
  ...
  double BsMassMC_;
  double BsCt2DMC_TrueMass_;
  double BsCosAlphaMC_;
  double BsJpsiMu2PtMC_  ;
  double BsJpsiMu1PtMC_  ;
  double BsJpsiMu1EtaMC_  ;
  double BsJpsiMu2EtaMC_  ;
  double BsJpsiMu1PhiMC_  ;
  double BsJpsiMu2PhiMC_  ;
  double BsJpsiPtMC_  ;
  double BsJpsiMassMC_  ;
  double BsPhiPtMC_  ;
  double BsPhiMassMC_  ;
  double BsPhiK1PtMC_  ;
  double BsPhiK2PtMC_  ;
  ...
  double genBsPV_z_ ,genBsPV_y_ ,  genBsPV_x_ ;
   double genBpPV_z_ ,genBpPV_y_ ,  genBpPV_x_ ;

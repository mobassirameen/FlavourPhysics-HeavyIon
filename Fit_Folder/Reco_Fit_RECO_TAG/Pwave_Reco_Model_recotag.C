...
void Pwave_Reco_Model_recotag(string filename, int maxOrder=6, int xbins=70, int ybins = 70, int zbins = 30){
//==========================================================================================================Efficiencies
...
//std::cout<<"orders of ploy, legendre"<<xOrder<<yOrder<<zOrder<<"\n";
 ...
 int degree = 5;
  ...
  std::cout<<"Projected Normalized 3D Angular Efficiency: "<<eff<<"\n";	
  ...
  //=================================================================================Model
   ...
   RooAbsReal* inter = ws->function("projectedFunc");  
   Double_t maxVal = inter->getVal(vars);
   RooRealVar *AE = new RooRealVar("AE","AE", maxVal);
   //RooRealVar *AE = new RooRealVar("AE","AE", eff);

   /* RooProduct *eq11=new RooProduct("eq11","amp0*g1",RooArgSet(*coshGConv,*fun1T,*AE));
    RooProduct *eq12=new RooProduct("eq12","amp0*g1",RooArgSet(*coef12,*sinhGConv,*fun1T,*AE));
    RooProduct *eq14=new RooProduct("eq14","amp0*g1",RooArgSet(*coef14,*sinGConv,*fun1T,*AE));
    RooProduct *eq21=new RooProduct("eq21","amp0*g1",RooArgSet(*coshGConv,*fun2T,*AE));
    RooProduct *eq22=new RooProduct("eq22","amp0*g1",RooArgSet(*coef22,*sinhGConv,*fun2T,*AE));
    RooProduct *eq24=new RooProduct("eq24","amp0*g1",RooArgSet(*coef24,*sinGConv,*fun2T,*AE));
    RooProduct *eq31=new RooProduct("eq31","amp0*g1",RooArgSet(*coshGConv,*fun3T,*AE));
    RooProduct *eq32=new RooProduct("eq32","amp0*g1",RooArgSet(*coef32,*sinhGConv,*fun3T,*AE));
    RooProduct *eq34=new RooProduct("eq34","amp0*g1",RooArgSet(*coef34,*sinGConv,*fun3T,*AE));
    RooProduct *eq42=new RooProduct("eq42","amp0*g1",RooArgSet(*coef42,*sinhGConv,*fun4T,*AE));
    RooProduct *eq43=new RooProduct("eq43","amp0*g1",RooArgSet(*coef43,*cosGConv,*fun4T,*AE));
    RooProduct *eq44=new RooProduct("eq44","amp0*g1",RooArgSet(*coef44,*sinGConv,*fun4T,*AE));
    RooProduct *eq51=new RooProduct("eq51","amp0*g1",RooArgSet(*coef51,*coshGConv,*fun5T,*AE));
    RooProduct *eq52=new RooProduct("eq52","amp0*g1",RooArgSet(*coef52,*sinhGConv,*fun5T,*AE));
    RooProduct *eq54=new RooProduct("eq54","amp0*g1",RooArgSet(*coef54,*sinGConv,*fun5T,*AE));
    RooProduct *eq62=new RooProduct("eq62","amp0*g1",RooArgSet(*coef62,*sinhGConv,*fun6T,*AE));
    RooProduct *eq63=new RooProduct("eq63","amp0*g1",RooArgSet(*coef63,*cosGConv,*fun6T,*AE));
    RooProduct *eq64=new RooProduct("eq64","amp0*g1",RooArgSet(*coef64,*sinGConv,*fun6T,*AE));
    RooProduct *eq71=new RooProduct("eq71","amp0*g1",RooArgSet(*coshGConv,*fun7T,*AE));
    RooProduct *eq72=new RooProduct("eq72","amp0*g1",RooArgSet(*coef72,*sinhGConv,*fun7T,*AE));
    RooProduct *eq74=new RooProduct("eq74","amp0*g1",RooArgSet(*coef74,*sinGConv,*fun7T,*AE));
    RooProduct *eq82=new RooProduct("eq82","amp0*g1",RooArgSet(*coef82,*sinhGConv,*fun8T,*AE));
    RooProduct *eq83=new RooProduct("eq83","amp0*g1",RooArgSet(*coef83,*cosGConv,*fun8T,*AE));
    RooProduct *eq84=new RooProduct("eq84","amp0*g1",RooArgSet(*coef84,*sinGConv,*fun8T,*AE));
    RooProduct *eq91=new RooProduct("eq91","amp0*g1",RooArgSet(*coef91,*coshGConv,*fun9T,*AE));
    RooProduct *eq92=new RooProduct("eq92","amp0*g1",RooArgSet(*coef92,*sinhGConv,*fun9T,*AE));
    RooProduct *eq94=new RooProduct("eq94","amp0*g1",RooArgSet(*coef94,*sinGConv,*fun9T,*AE));
    RooProduct *eq102=new RooProduct("eq102","amp0*g1",RooArgSet(*coef102,*sinhGConv,*fun10T,*AE));
    RooProduct *eq103=new RooProduct("eq103","amp0*g1",RooArgSet(*coef103,*cosGConv,*fun10T,*AE));
    RooProduct *eq104=new RooProduct("eq104","amp0*g1",RooArgSet(*coef104,*sinGConv,*fun10T,*AE));
*/
 ...
 /*              RooPlot* CosTheta = BscosthetaMC->frame(Title(title1),Bins(nbins));
   ...
   */            
              ...
              /* RooPlot* PHI = BsphiMC->frame(Title(title3),Bins(nbins));
               ...
               RooPlot* Deltact = BsCt2DMCErr->frame(Title(title5),Bins(nbins));
               data->plotOn(Deltact, DataError(RooAbsData::SumW2));
               Angular_Model->plotOn(Deltact);
               Angular_Model->paramOn(Deltact);
               Angular_Model->plotOn(Deltact , LineColor(kBlack), LineWidth(1));
               Double_t chisquare_deltact = Deltact->chiSquare();
               RooPlot* deltactpull = svmass->frame(RooFit::Title("Mass pull"));
               RooHist* hpull2 = Deltact->pullHist();
                ...
                Double_t chisquare_ct = ct->chiSquare();
                 ...
                 RooPlot* masspull = svmass->frame(RooFit::Title("Mass pull"));
    ...
    Angular_Model->plotOn(bsmass, Components(*gauss3), LineColor(6), LineWidth(2), LineStyle(2));            
             ...
             Angular_Model->plotOn(Deltact, Components(*G1), LineColor(3), LineWidth(2), LineStyle(4));
             Angular_Model->plotOn(Deltact, Components(*G2), LineColor(2), LineWidth(2), LineStyle(2));
           ...
           //    cc->Print("ctheta.root", "root");
             ...
             //  TCanvas *cc22 = new TCanvas("cc22", "cc22",0,0,800,600);
              ...
              // cc22->Print("phit.root", "root");
               ...
               cc33->SetFillColor(0);
               cc33->SetBorderSize(2);
               cc33->SetLeftMargin(0.1422222);
               cc33->SetRightMargin(0.04444445);
               ct->SetStats(0);
               ct->Draw();
               auto cms1 = new TLatex(0.02, 26200, "#bf{CMS} #it{Simulations}, #sqrt{#bf{s}} = #bf{13 TeV}");
               cms1->SetNDC(false);
               ...
               gStyle->SetOptTitle(0);
               cc66->SetFillColor(0);
               cc66->SetBorderSize(2);
               cc66->SetLeftMargin(0.1422222);
               cc66->SetRightMargin(0.04444445);
               bsmass->SetStats(0);
               bsmass->Draw();
               auto cms2 = new TLatex(5.28, 22000, "#bf{CMS} #it{Simulations}, #sqrt{#bf{s}} = #bf{13 TeV}");
               cms2->SetNDC(false);
               cms2->SetTextColor(12);
               cms2->SetTextFont(42);
               cms2->SetTextSize(0.055);
               cms2-> Draw();
               pad4->cd();
               masspull->addPlotable(hpull1,"P0") ;
               masspull->SetMinimum(-5) ;
               masspull->SetMaximum(5) ;
               masspull->SetYTitle("pull");
               masspull->SetMarkerStyle(20);               
               masspull->SetNdivisions(10);
               masspull->Draw();
               cc66->cd();
               cc66->Print("bsmass_2017.root", "root");


               TCanvas *cc77 = new TCanvas("cc77", "cc77",0,0,800,600);
               ...
               gStyle->SetOptTitle(0);
               cc77->SetFillColor(0);
               cc77->SetBorderSize(2);
               cc77->SetLeftMargin(0.1422222);
               cc77->SetRightMargin(0.04444445);
               ...
               cms12-> Draw();        
               pad22->cd();
               deltactpull->addPlotable(hpull2,"P0") ;
               deltactpull->SetMinimum(-5) ;
               deltactpull->SetMaximum(5) ;
               deltactpull->SetYTitle("#Delta(ct) pull");
               deltactpull->SetMarkerStyle(20);               
               deltactpull->SetNdivisions(10);
               deltactpull->Draw();  
               cc77->cd();
*/
...
TFile *output = new TFile("FitResults_RecoTagMistag.root","recreate");

...
void ratios(int runnumber=286178){
 ...
 // writeExtraText = true;       // if extra text
  ...
  TH1F* HAD21_neg = new TH1F("HAD21 neg",";HAD#minus2/HAD#minus1;Events",100,0.0,2.0);
  TH1F* HAD31_neg = new TH1F("HAD31 neg",";HAD#minus3/HAD#minus1;Events",100,0.0,2.0);
  TH1F* HAD41_neg = new TH1F("HAD41 neg",";HAD#minus4/HAD#minus1;Events",100,0.0,2.0);

  TH1F* HAD21_pos = new TH1F("HAD21 pos",";HAD#plus2/HAD#plus1;Events",100,0.0,2.0);
  TH1F* HAD31_pos = new TH1F("HAD31 pos",";HAD#plus3/HAD#plus1;Events",100,0.0,2.0);
  TH1F* HAD41_pos = new TH1F("HAD41 pos",";HAD#plus4/HAD#plus1;Events",100,0.0,2.0);

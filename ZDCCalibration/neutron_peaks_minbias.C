...
void neutron_peaks_minbias(int runnumber=286178){
  ...
  TFile *f = new TFile("/Users/ab/Documents/ZDCCalibration/zdc_digi_minbias.root"); // opening the root file
...
/*      if(side == 0 && type == 1 && channel == 2 && (iMax == 4 || iMax == 5) && adcLeaf[iMax]->GetValue(n) < 254 && adcLeaf[iMax]->GetValue(n) > 120)
  ...
  c1->SaveAs("/Users/ab/Documents/ZDCCalibration/neutronpeaks/tune_2D_pos.pdf");
  c1->SaveAs("/Users/ab/Documents/ZDCCalibration/neutronpeaks/tune_2D_pos.png");
  tune_2D_pos->Write();

  tune_2D_neg->Draw("colz");
  c1->SaveAs("/Users/ab/Documents/ZDCCalibration/neutronpeaks/tune_2D_neg.pdf");
  c1->SaveAs("/Users/ab/Documents/ZDCCalibration/neutronpeaks/tune_2D_neg.png");
  tune_2D_neg->Write();
  ...
  c1->SaveAs("/Users/ab/Documents/ZDCCalibration/neutronpeaks/totEnergy.pdf");
  c1->SaveAs("/Users/ab/Documents/ZDCCalibration/neutronpeaks/totEnergy.png");
  totEnergy_neg->Write();

  totEnergy_2D->Draw("colz");
  c1->SaveAs("/Users/ab/Documents/ZDCCalibration/neutronpeaks/totEnergy_2D.pdf");
  c1->SaveAs("/Users/ab/Documents/ZDCCalibration/neutronpeaks/totEnergy_2D.png");
  totEnergy_2D->Write();

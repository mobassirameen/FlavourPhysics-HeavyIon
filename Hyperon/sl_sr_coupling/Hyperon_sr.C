...
//=================================================================================================================Helicity Amplitudes
        h120s = abs((real(sright))*(srQplus/(msquark-mupquark))*((mxi-msigma)*f1V + (q2/mxi)*f3V));
        h120p = abs((real(sright))*(srQminus/(msquark+mupquark))*(-(mxi+msigma)*f1A + (q2/mxi)*f3A));
...
//===============================================================================================================================================================
    ...
    legend->SetHeader("only g_{R}^{S}","C");
    ...
    legend1->AddEntry(diffAsFq2, "Only g_{R}^{S}");
    ...
    legend2->AddEntry(AFBAsFq2, "Only g_{R}^{S}");
    ...
    legend3->AddEntry(ConAsFq2, "Only g_{R}^{S}");
    ...
    legend4->AddEntry(HadPolAsFq2, "Only g_{R}^{S}");
    ...
    legend5->AddEntry(BRFracAsFq2, "Only g_{R}^{S}");

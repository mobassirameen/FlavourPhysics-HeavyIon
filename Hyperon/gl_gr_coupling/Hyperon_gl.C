...
void Hyperon_gl(){
    ...
    auto  *SMdiffAsFq2 = new TProfile("SMdiffAsFq2", "DecayWidth as Function of q^{2}; q^{2} (GeV); d#Gamma/dq^{2}dcos#theta", nbins, 0.0,0.0150,0,0.001);
    ...
    auto  *AFBAsFq2 = new TProfile("AFBAsFq2", "FB asymmetry as Function of q^{2}; q^{2} (GeV); A_{FB}", nbins, 0.0,0.0150,-1,1);
    auto  *SMAFBAsFq2 = new TProfile("SMAFBAsFq2", "FB asymmetry as Function of q^{2}; q^{2} (GeV); A_{FB}", nbins, 0.0,0.0150,1,1);
    auto  *ConAsFq2 = new TProfile("ConAsFq2", "Convexity parameter  as Function of q^{2}; q^{2} (GeV); Convexity", nbins, 0.0,0.0150,-0.5,0.5);
    auto  *SMConAsFq2 = new TProfile("SMConAsFq2", "Convexity parameter  as Function of q^{2}; q^{2} (GeV); Convexity", nbins, 0.0,0.0150,-2,2);
    ...
    auto  *SMHadPolAsFq2 = new TProfile("SMHadPolAsFq2", "Hadronic polarization  as Function of q^{2}; q^{2} (GeV); Hadronic Polarization", nbins, 0.0,0.0150,-0.5,0.5);
    auto  *BRFracAsFq2 = new TProfile("BRFracAsFq2", "BR fraction   as Function of q^{2}; q^{2} (GeV); BR", nbins, 0.0,0.0150,0, 1e-8);
    auto  *SMBRFracAsFq2 = new TProfile("SMBRFracAsFq2", "BR fraction   as Function of q^{2}; q^{2} (GeV); BR", nbins, 0.0,0.0150,0, 1e-8);
...
//=================================================================================================================Helicity Amplitudes
        ...
        h120v = abs((1.0+real(gleft))*(srQminus/sqrt(q2))*((mxi+msigma)*f1V + (q2/mxi)*f2V));
        h121v = abs((1.0+real(gleft))*(sqrt(2.0)*srQminus)*(-f1V - ((mxi+msigma)/mxi)*f2V));
        h12tv = abs((1.0+real(gleft))*(srQplus/sqrt(q2))*((mxi-msigma)*f1V + (q2/mxi)*f3V));
        h120a = abs((1.0+real(gleft))*(srQplus/sqrt(q2))*(-(mxi-msigma)*f1A + (q2/mxi)*f2A));
        h121a = abs((1.0+real(gleft))*(sqrt(2.0)*srQplus)*(f1A - ((mxi-msigma)/mxi)*f2A));
        h12ta = abs((1.0+real(gleft))*(srQminus/sqrt(q2))*(-(mxi+msigma)*f1A + (q2/mxi)*f3A));
...
//===============================================================================================================================================================
          ...
          SMHadronic_Polarization = (SMConsTant_Factor*sf*(1/2.0*mxi)*sqrt(Qplus*Qminus)*(1-(mlepton*mlepton/q2))*(q2-mlepton*mlepton)*SMResultant_Had_Pol)/(SMdGamma_Dq2) ;
    ...
    legend1->AddEntry(diffAsFq2, "Only g_{L}");
    ...
    legend2->AddEntry(AFBAsFq2, "Only g_{L}");
    ...
    legend3->AddEntry(ConAsFq2, "Only g_{L}");
    legend3->AddEntry(SMConAsFq2, "SM");
    legend3->Draw();
    
    TCanvas * c5 = new TCanvas();
    SMHadPolAsFq2->Draw();
    HadPolAsFq2->Draw("same");
    ...
    legend4->AddEntry(HadPolAsFq2, "Only g_{L}");
    legend4->AddEntry(SMHadPolAsFq2, "SM");
    legend4->Draw();
    
    TCanvas * c6 = new TCanvas();
    SMBRFracAsFq2->Draw();
    BRFracAsFq2->Draw("same");
    ...
    legend5->AddEntry(BRFracAsFq2, "Only g_{L}");
